...
Par ailleurs une clef API gratuite openweathermap.org est nécessaire (voir sur leur site). créez un compte gratuit pour ensuite obtenir une clef API gratuite.
